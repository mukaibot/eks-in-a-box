...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'The easy way to spin up an EKS cluster at REA'
  spec.description   = 'Creates EKS cluster and configures components in Kubernetes to make the cluster useful'
  ...
  spec.files = Dir.chdir(File.expand_path(__dir__)) do
    `git ls-files -z`.split("\x0").reject { |f| f.match(%r{^(test|auto|.buildkite|.gitignore)/}) }
  end
  spec.bindir        = 'bin'
